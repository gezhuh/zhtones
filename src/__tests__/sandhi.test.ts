...
import { HALF_THIRD_CONTOUR, TONE_CONTOURS } from '../tones/contours';
...
describe('sandhi', () => {
  it('T3 + T3 surfaces as T2 + T3', () => {
    ...
    expect(r.surfaceContours[1]).toEqual(TONE_CONTOURS[3]);
  });
  ...
  it('一 before T1/T2/T3 becomes T4', () => {
  ...
  it('不 before T4 becomes T2; otherwise stays T4', () => {
